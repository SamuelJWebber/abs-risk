...
## Download list once unblocked (direct, UA `abs-risk/0.1 research (+https://github.com/SamuelJWebber/abs-risk)`, <=2 req/s)
Save under `data/raw/scout/cards/<slug>/`:
